...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="<?= css_url('morris.css'); ?>" rel="stylesheet">
    ...
    if ($css) {
        foreach($css as $css_item) {
            ?><link rel="stylesheet" href="<?= css_url($css_item);?>"><?php
        }
    }
    ?>
</head>
...
<script src="<?= js_url('raphael-min.js'); ?>"></script>
<script src="<?= js_url('morris.min.js'); ?>"></script>
...
if ($js) {
    foreach($js as $js_item) {
        ?><script src="<?= js_url($js_item);?>"></script><?php
    }
}
?>
