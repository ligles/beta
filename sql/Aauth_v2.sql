...
-- ----------------------------
INSERT INTO `aauth_perms` VALUES ('users_manage','Manage','Gérer les utilisateurs','1');
INSERT INTO `aauth_perms` VALUES ('users_create','Create','Créer des utilisateurs','1');
INSERT INTO `aauth_perms` VALUES ('users_read','Read','Consulter des utilisateurs','1');
INSERT INTO `aauth_perms` VALUES ('users_update','Update','Mettre à jour des utilisateurs','1');
INSERT INTO `aauth_perms` VALUES ('users_delete','Delete','Supprimer des utilisateurs','1');


-- ----------------------------
-- Table structure for `kiim_action`
-- ----------------------------
DROP TABLE IF EXISTS `kiim_action`;
CREATE TABLE `kiim_action` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100),
  `alias` varchar(50),
  `definition` text,
...
-- ----------------------------
-- Records of kiim_action
-- ----------------------------
-- 1 menu = 1 Action (en theorie)
INSERT INTO `kiim_action` VALUES ('users','Users','Gérer les utilisateurs');
